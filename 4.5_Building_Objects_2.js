...
vehicle1.capacity+=4;
vehicle2.sumersible= false;
vehicle3.weapon="Torpedoes";
vehicle1.sumersible=false;
vehicle2.weapon="laser";
vehicle3.capacity *=2;
vehicle1.type="Rear-Mounted Slingshot";
vehicle3.sumersible=true;


console.log(vehicle1.capacity);
console.log(vehicle2.sumersible);
console.log(vehicle3.weapon);
console.log(vehicle1.sumersible);
